...
//std::unordered_map<std::string, std::vector<Control>> Controller::controls;
void Controller::loadControls()
{
	/*/std::unordered_map<std::string, int> controls;
	std::string file = Util::readTextFile("..\\Game\\controls.txt");
	...
	for (std::string line : lines)
	{
		...
		controls.insert(std::make_pair(Util::removeFromString(controlType, "_", " "), controllers));
	}*/
}
